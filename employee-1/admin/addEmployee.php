...
?>
    ...
    <form  method="POST" action="" id="admin_form" >  
        ...
        <div class="md-form mb-3 form_row">
            ...
            <input type="text" class="form-control validate field" id="department" placeholder="Department" name="department"  required >
        </div> 
        <div class="md-form mb-3 form_row">
...
$query=mysqli_query($con,"INSERT INTO employee_details VALUES('','$eid','$username','$gender','$email','$dobb','$contact','$department','$organisationId','$password')");
