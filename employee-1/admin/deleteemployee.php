...
if(isset($_GET['delete'])){
 ...
 $query=mysqli_query($con,"DELETE FROM employee_details WHERE eid='$deleteId' AND organisation='$organisationId'");
 ...
 if($query){
     ?>
     <script>
          if(!alert('Employee deleted successfully.')){window.location = "employee.php";}
     </script>
